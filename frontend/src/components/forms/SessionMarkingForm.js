...
export default function SessionMarkingForm() {
  ...
  const [sessionType, setSessionType] = useState(
    user?.profile?.roles.name === "head coach" ? "pe_sessions_participants" : "academic_sessions_participants"
  );
  ...
  useEffect(() => {
    const table = sessionType === "academic_sessions_participants" ? "academic_sessions" : "pe_sessions";
