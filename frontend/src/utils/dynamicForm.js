...
// //   twoStepFileUpload: PropTypes.bool,
// //   fileUploadRouteBuilder: PropTypes.func,
...
//       // Combine presetFields + formData
//       const combinedData = { ...presetFields, ...formData };

//       // If model is session and combinedData has 'student', convert to 'students' array for backend
//       if (
...
//         // Replace single "student" select with multi-select "students" for sessions
//         if (
//           (model === "PESession" || model === "AcademicSession") &&
//           field.name === "student" &&
//           field.type === "select"
...
//         // Existing select rendering for all other selects
